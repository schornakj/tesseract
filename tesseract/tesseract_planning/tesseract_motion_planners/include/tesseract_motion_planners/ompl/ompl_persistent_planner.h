/**
 * @file ompl_persistent_planner.h
...
#ifndef TESSERACT_MOTION_PLANNERS_OMPL_PERSISTENT_PLANNER_H
#define TESSERACT_MOTION_PLANNERS_OMPL_PERSISTENT_PLANNER_H
...
{
class OMPLPersistentPlanner : public MotionPlanner
{
public:
  /** @brief Construct a planner */
  OMPLPersistentPlanner(std::string name = "OMPL");
...
#endif // TESSERACT_MOTION_PLANNERS_OMPL_PERSISTENT_PLANNER_H
